...
export const verifyEmailTemplate = (data:TVerifyEmailType) => {
const { fullName, otp: OTP, token, expiry_minutes, company_name, CLIENT_URL } = data
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%"
        ...
        <tr>
            <td style="padding:30px; color:#333333; font-size:16px; line-height:24px;">
                ...
                <p
                    style="margin:20px 0; font-size:18px; font-weight:bold; text-align:center; letter-spacing:4px; color:#4a6cf7;">
                    ${OTP}
                </p>
